...
<main class="vh-100">
  <div class="container-fluid">
    <div class="col-md-12">
      ...
      <form action="<?php echo URLROOT; ?>/admins/editUser/<?php echo $data['user_id']; ?>" method="POST" id="formUser" enctype="multipart/form-data">
        <h5 class="my-4 dark-grey-text font-weight-bold"><i class="fas fa-user mr-2"></i> Edit User</h5>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <select class="browser-default custom-select" action="formUser" id="userRole" name="role">
                      <option value="<?php echo $data['role']; ?>" selected>Selected: <?php echo ucwords($data['role']); ?></option>
                ...
                <div class="row">
                  <div class="col-12 pt-1">
                    <button class="btn btn-success btn-block" type="submit" value="Edit User">Edit User</button>
                  </div>
                </div>
              </div>
            </div>
