  ...
  <section class="h-100 h-custom gradient-custom-2">
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-md-8">
          <form action="<?php echo URLROOT; ?>/users/edit/<?php echo $data['user_id']; ?>" method="POST">
            <div class="card">
                ...
                <div class="row g-0">
                  <div class="col-md-12">
                    ...
                    <div class="p-5">
                      ...
                      <h3 class="h3-responsive fw-normal orange-text mb-3">Edit User Details</h3>
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 pt-1 mb-3">
                          <button class="btn btn-orange btn-block" type="submit" value="Edit">Edit</button>
                        </div>
                      </div>
